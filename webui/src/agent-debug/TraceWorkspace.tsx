...
function speechDiff(before: AgentDebugResponse, after: AgentDebugResponse): DiffRow[] {
  const oldSpeech = before.speechSimulation;
  const newSpeech = after.speechSimulation;
  return [
    scalarDiff("最终文本", oldSpeech.text, newSpeech.text),
    scalarDiff("参与动作", oldSpeech.action, newSpeech.action),
    scalarDiff("发言场景", oldSpeech.scene, newSpeech.scene),
    scalarDiff("话语动作", oldSpeech.act, newSpeech.act),
    scalarDiff("话轮压力", oldSpeech.turn_pressure, newSpeech.turn_pressure),
    scalarDiff("目标成员", oldSpeech.target_user_id, newSpeech.target_user_id),
    scalarDiff("话题", oldSpeech.topic, newSpeech.topic),
    scalarDiff("话题动作", oldSpeech.topic_action, newSpeech.topic_action),
    scalarDiff("决策原因", oldSpeech.reason, newSpeech.reason),
    scalarDiff("消息段", oldSpeech.segments, newSpeech.segments),
    scalarDiff("Persona 风格", oldSpeech.style, newSpeech.style),
    scalarDiff("Emotion", oldSpeech.emotion, newSpeech.emotion),
